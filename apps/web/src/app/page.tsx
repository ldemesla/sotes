...
export default async function Home() {
  ...
  return (
    <div className="bg-card relative flex h-full flex-1 flex-col gap-6 overflow-hidden rounded-lg p-12 shadow-md">
      <div className="mb-4">
        <h1 className="font-serif text-2xl font-medium text-black/90">Hello, Fredrika</h1>
        <p className="font-serif text-2xl font-medium text-black/30">What&apos;s on your mind?</p>
      </div>
